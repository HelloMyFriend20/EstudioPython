...
#Hereda atributos de una clase padre o superclase
#Una segunda clase puede ser clase padre de clase 3 y subclase de padre 1

#Sirve para reutilizar código en caso de crear objetos similares
#Nos sirve preguntarnos que caracteristicas y comportamientos tienen en comun todos los objetos

#Como hacer que las clases se hereden
class Vehiculos():
